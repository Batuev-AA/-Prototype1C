...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм,
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "Храм_ЕпархиальныйОтчет") Тогда
		
		// Формируем табличный документ и добавляем его в коллекцию печатных форм.
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм, "Храм_ЕпархиальныйОтчет", "Епархиальный отчет", 
			ПечатьЕпархиальныйОтчет(МассивОбъектов, ОбъектыПечати), , "Документ.ПФ_MXL_Храм_ЕпархиальныйОтчет.ПФ_MXL_Храм_ЕпархиальныйОтчет");
	КонецЕсли;
