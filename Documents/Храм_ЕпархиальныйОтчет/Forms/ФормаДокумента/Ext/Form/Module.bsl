...
Функция ПечатьКнигаУчетаЦелевыхНаСервере()
	...
	Пока Выборка.СледующийПоЗначениюПоля("Ссылка") Цикл
		...
		//|	ВЫБОР
		//|		КОГДА Храм_КнигаУчета.ДокументХозяйственнойОперации.ТипДокумента = ""ПлатежноеПоручение""
		//|			ТОГДА Храм_КнигаУчета.ДокументХозяйственнойОперации.НазначениеПлатежа
		//|		КОГДА Храм_КнигаУчета.ДокументХозяйственнойОперации.ТипДокумента = ""ПоступлениеНаРасчетныйСчет""
		//|			ТОГДА Храм_КнигаУчета.ДокументХозяйственнойОперации.НазначениеПлатежа
		//|		КОГДА Храм_КнигаУчета.ДокументХозяйственнойОперации.ТипДокумента = ""СписаниеСРасчетногоСчета""
		//|			ТОГДА Храм_КнигаУчета.ДокументХозяйственнойОперации.НазначениеПлатежа
		//|		КОГДА Храм_КнигаУчета.ДокументХозяйственнойОперации.ТипДокумента = ""ПриходныйКассовыйОрдер""
		//|			ТОГДА Храм_КнигаУчета.ДокументХозяйственнойОперации.Приложение
		//|		КОГДА Храм_КнигаУчета.ДокументХозяйственнойОперации.ТипДокумента = ""РасходныйКассовыйОрдер""
		//|			ТОГДА Храм_КнигаУчета.ДокументХозяйственнойОперации.Приложение
		//|		КОГДА Храм_КнигаУчета.ДокументХозяйственнойОперации.ТипДокумента = ""ОперацияБух""
...
Функция ПечатьКнигаУчетаНеразнесенныхНаСервере()
	...
	Пока Выборка.СледующийПоЗначениюПоля("Ссылка") Цикл
		...
		Пока Выборка1.Следующий() Цикл
			...
			СтруктураОборотСтроки.Вставить("Дата", Формат(Выборка1.Период,"ДЛФ=Д"));
			СтруктураОборотСтроки.Вставить("Содержание", "" +  ДокументСсылка);
